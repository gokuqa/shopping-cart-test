(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_25f8df._.js", {
...
const Product = ({ srcImage, title, code, price, itemQuantity, setItemQuantity })=>{
    _s();
    // Estado local que guarda la cantidad de un producto específico
    ...
    // Función general para actualizar la cantidad del producto
    const updateQuantity = (increment)=>{
        // Calculamos la nueva cantidad sumando o restando 1 según la acción
        const newQuantity = increment ? quantity + 1 : quantity - 1;
        // Solo permitimos cantidades no negativas
        if (newQuantity >= 0) {
            setQuantity(newQuantity);
            // Si la cantidad aumenta, agregamos el producto al carrito
            if (increment) {
                ...
                setItemQuantity(itemQuantity + 1); // Actualizamos la cantidad total de productos en el carrito
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Data$2f$Cart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteProductFromCart"])(code); // Si disminuye, eliminamos el producto del carrito
                setItemQuantity(itemQuantity - 1); // Actualizamos la cantidad total de productos en el carrito
            }
        }
    };
...
const ProductsContainer = ({ itemQuantity, setItemQuantity })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Data$2f$Products$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Products"].map((product)=>// Se usa el código del producto como key en lugar de combinar título e índice
...
const CartModal = ({ handleClose })=>{
    ...
    const calculateTotalPrice = ()=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Data$2f$Cart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCarrito"])().reduce((total, item)=>{
            // Obtener el precio del producto usando el código. Si no existe, retornamos 0.
    ...
    const handleProceed = ()=>{
        ...
        // Cerrar el modal después de proceder con la compra
        handleClose();
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "CartModal",
...
//# sourceMappingURL=src_app_25f8df._.js.map